...
/**
 * 本示例使用 EnumSet 轻松从 enum 中创建 Set 。（可以在第二十二章枚举一章中了解有关EnumSet 的更多信息。）
 * 在这里，静态方法 EnumSet.range() 要求提供所要在结果Set 中创建的元素范围的第一个和最后一个元素
 *
 */
...
union(set1, set2): [MAGENTA, COBALT_BLUE_HUE, VIOLET,VIRIDIAN_HUE, BURNT_SIENNA, ULTRAMARINE,CERULEAN_BLUE_HUE, BURNT_UMBER, BRILLIANT_RED,PHTHALO_BLUE, YELLOW_OCHRE, SAP_GREEN, CRIMSON,ROSE_MADDER, RAW_UMBER, PERMANENT_GREEN]
intersection(set1, set2): [COBALT_BLUE_HUE,VIRIDIAN_HUE, ULTRAMARINE, CERULEAN_BLUE_HUE,PHTHALO_BLUE, PERMANENT_GREEN]
difference(set1, subset): [CRIMSON, MAGENTA, VIOLET,ROSE_MADDER, BRILLIANT_RED]
difference(set2, subset): [BURNT_SIENNA, BURNT_UMBER,YELLOW_OCHRE, RAW_UMBER, SAP_GREEN]
complement(set1, set2): [MAGENTA, VIOLET, BURNT_SIENNA,BURNT_UMBER, BRILLIANT_RED, YELLOW_OCHRE, SAP_GREEN,CRIMSON, ROSE_MADDER, RAW_UMBER]
*/
