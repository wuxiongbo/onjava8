...
public class AtUnit implements ProcessFiles.Strategy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        args =new String[]{".\\onjava"};// 为了避免报错，加了这行代码
    ...
    private static Method checkForCreatorMethod(Method m) {
        if (m.getAnnotation(onjava.atunit.TestObjectCreate.class) == null)
            return null;
    ...
    private static Method checkForCleanupMethod(Method m) {
        if (m.getAnnotation(onjava.atunit.TestObjectCleanup.class) == null)
            return null;
...
//        try {
//            Class<?> processFiles = Class.forName("ProcessFiles");
//            Constructor<?> constructor = processFiles.getConstructor(AtUnit.class, String.class);
//            Object object = constructor.newInstance(new AtUnit(), "class");
//
//            Method startMethod = processFiles.getMethod("start");
